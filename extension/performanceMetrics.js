(function () {
  const names = ["scansStarted", "scansCoalesced", "cardsVisible", "cardsDeferred", "semanticCandidates", "semanticBailouts", "visualCandidates", "visualBailouts", "visualCacheHits", "visualInflightJoins"];
